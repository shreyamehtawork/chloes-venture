...
export default function Beauty() {
  ...
  return (
    <div className="fashion-page">
      {/* Hero */}
      <section className="hero-section-beauty text-white text-center d-flex align-items-center justify-content-center">
        <div className="overlay"></div>
        <div className="hero-content">
          <h1 className="display-4 fw-bold">Chloe’s Beauty Collection</h1>
